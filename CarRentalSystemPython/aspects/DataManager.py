...
class DataManager(Generic[T, E], ISerializeOwner):
    ...
    def read_data_extended(self, targetList: List[T], entityType: EntityType, dataType: DataType, fileSuffix: str, owner: IEntitiesList) -> None:
            ...
            listItems = self.read_data_extended_job(entityType, dataType, fileSuffix)
